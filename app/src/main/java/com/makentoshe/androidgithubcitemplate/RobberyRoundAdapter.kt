...
class RobberyRoundAdapter(var context: Context,
   ...
   /* interface onItemClickListener{
    ...
    class RobberyRoundAdapterHolder(itemView: View/*,listener: TeamsAdapter.onItemClickListener*/) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onBindViewHolder(holder: RobberyRoundAdapterHolder, position: Int) {
       /* holder.teamRobbery.text = teamsNames[position]
        ...
        holder.teamRobbery.text = "igfigwf"
 holder.counterRobbery.text="0"
